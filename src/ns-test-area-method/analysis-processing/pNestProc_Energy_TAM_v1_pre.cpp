...
///
//Input File Name
string filename = "Epoints_NS_CP_xfilx_comb.dat";
string filename2 = "zObservables_NS_CP_xfilx_comb.dat";
//Output File Name
string outfilename = "zNestOut_CP_xfilx.dat";
