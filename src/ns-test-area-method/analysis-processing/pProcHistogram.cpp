...
{
//Input File Name
string filename = "Epoints_NS_n256_a0.dat";
string filename2 = "zLDhist_NS_n256_a0.dat";
//Output File Name
//string outfilename = "zCv_int_cube_d8_test_itagi_reprrtagrr.dat";
string outfilenamepre = "zLDhist_NS_n256_a0_";
long double kb = 1.0;
long double Tstart = 0.4;
long double Tfinish = 2.0;
unsigned long Tloop = 17;
long double binwidth = 0.001;
const unsigned NumElements = 5000 ;
long double Beta;
long double Temp;
