...
string filename = "ab2_rep2_clean.dat";
//number of columns
unsigned ncol1 = 10;
...
unsigned acol1 = 7;
string filename2 = "a0_rep0_clean.dat";
unsigned ncol2 = 10;
unsigned lcol2 = 6;
//column number that temperature is in - starts at 1
unsigned tcol2 = 1;
//Output File Name
string outfilename = "zNest_Gamma100_ab2_a0_rep2.dat";
...
//	long double dgv = -T*( Nab*log(Vab) - Na*log(Va) - Nb*log(area) );
	...
	outfile<<T<<" "<<gab<<" "<<dg<<" "<<ga<<" "<<area<<" "<<dG<<" "<<dA<<" "<<gamma<<" "<<(dg+dgVo)/(2.0*dA)<<endl;
