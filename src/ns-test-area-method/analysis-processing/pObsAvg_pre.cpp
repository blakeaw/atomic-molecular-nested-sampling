...
//Input file
string infilename = "xfilx_clean.dat" ;
//Output file
string outfilename = "aNest_xfillx.dat";
...
for(unsigned i=0;i<numpts;++i){
	...
	outfile << Temp[i] << " " << Cvstat.Mean() << " " << 2.0*stderror<< " "<<Cvstat.StandDev() << endl;
	Cvstat.Reset();
