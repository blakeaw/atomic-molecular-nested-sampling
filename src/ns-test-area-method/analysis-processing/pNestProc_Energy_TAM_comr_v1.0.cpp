...
///
//Input File Name
string filename = "Epoints_NS_n17_a2.dat";
string filename2 = "zObservables_NS_n17_a2.dat";
//Output File Name
string outfilename = "zNestOut_n17_a2.dat";
...
//	cout<<"obs1 "<<Obs1<<" obs3 "<<Obs3<<" obs4 "<<Obs4<<endl;
	outfile<<std::scientific << setiosflags(ios::fixed)<< setprecision(15)<<Temp<<" "<<Zest<<" "<<H<<" "<<C<<" "<<cvn<<" "<<G<<" "<<mu<<" "<<Obs1<<endl;
}
