...
//Input File Name
string filename = "ab4_cp_clean.dat";
//number of columns
unsigned ncol1 = 10;
...
unsigned tcol1 = 1;
string filename2 = "a2_cp_clean.dat";
unsigned ncol2 = 10;
unsigned lcol2 = 6;
//column number that temperature is in - starts at 1
unsigned tcol2 = 1;
//Output File Name
string outfilename = "zNest_Gamma100_ab4_a2_cp.dat";
...
//	long double dgv = -T*( Nab*log(Vab) - Na*log(Va) - Nb*log(area) );
	...
	outfile<<T<<" "<<gab<<" "<<dg<<" "<<ga<<" "<<area<<" "<<dG<<" "<<dA<<" "<<gamma<<" "<<dgv<<endl;
	...
	cout<<"lh "<<lh<<" lnb "<<lnb<< " dg2 "<<dg2<<" dg3 "<<dg3<<" dg3/dA "<<dg3/dA<<" dg3/(2dA) "<<dg3/(2.0*dA)<<endl;
}
