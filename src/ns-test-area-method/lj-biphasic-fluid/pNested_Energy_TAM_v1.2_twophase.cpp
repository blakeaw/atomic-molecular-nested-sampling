...
//	boxz/=(sca*sca);
	...
	const long double Elow = -3000.0;
	long double Binwidth = 1.0e-3;

		//run descriptor
	string nds = itos(natoms);
	string rundescript = "NS_n"+nds+"_ab0_rep2";
...
logfile << " " << endl;
	...
	logfile<<"Constant Volume Nested Sampling of binary lennard jones system with TAM"<<endl;
