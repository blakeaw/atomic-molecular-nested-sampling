...
int main(int argc, char *argv[])
{
	...
	//Translation step
	const long double bsfac = 0.0700;
	...
	long double Elow = -400.0;
	long double Binwidth = 0.1;


		//run descriptor
	string nds = itos(natoms);
	string rundescript = "MC_n"+nds+"_c0_T0.7_c";
...
logfile << " " << endl;
	...
	logfile<<"Constant Volume MC Monte Carlo of lennard jones system with TAM"<<endl;
...
obsoutfile<<Eavg<<" "<<Esqavg<<" "<<LDavg<<" "<<dUavg<<" "<<dUsavg<<" "<<dUcavg<<" "<<gamma<<endl;
Eohist.Normalize();
