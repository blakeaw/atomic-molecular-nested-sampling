...
int main(int argc, char *argv[])
{
	...
	const unsigned long int Iterations = 20;
	//Number of Markov style iterations to adjust configuration
	const unsigned long long MCit = 800000;
	...
	string rundescriptor = "cube_d2_test_mtest_b";
...
cout<<"Will run " <<numreplicates<<" replicates of system:"<<endl;
