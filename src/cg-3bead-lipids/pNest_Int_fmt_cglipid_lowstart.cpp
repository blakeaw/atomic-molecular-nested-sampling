...
int main(int argc, char *argv[])
{
	...
	const unsigned short nlipids = 4000;
	...
	const unsigned long long MCit = 75000000;
	...
	const long double NSfrac = 0.250;
...
//	long double box = ((long double)(nlipids)*(rad1+rad2)*2.0)+rad1+rad2;
	...
	long double Ehigh = -3.0*(long double)(nlipids);
	const unsigned collectstepguess = nlipids*5;
	unsigned collectstep = collectstepguess;
	//Output Files
	string rundescript = "cube_l4000_low_test_0";
	//Name of logfile
...
//	long double Et1 = TotalPairEnergy(confn);
	...
	coordsfile << nbeads << endl;
			coordsfile << "coarse grained lipids with Energy " << Et1 << endl;
