...
int main(int argc, char *argv[])
{
	...
	const unsigned long int Iterations = 5;
	...
	const unsigned long Eqit = 100000;
...
//	const long double box = (1.250*(long double)(nlipids));
	...
	const unsigned int ConfigsOutFreq = (MCit-Eqit)/5; 
...
//		bool dccheck = confn.BoxCheck();
		bool dccheck = confn.BoxCheck(Lrandom);
	...
	//	cout << " Et1: " << Et1 << endl;
		...
		if(j>Eqit && j%ConfigsOutFreq ==0){
			...
			coordsfile << "coarse grained lipids with Energy " << Ee << endl;
