...
///
//Input File Name
string filename = "Epoints_NS_comr_n38_a9.dat";
string filename2 = "zObservables_NS_comr_n38_a9.dat";
//Output File Name
string outfilename = "zNestOut_comr_n38_a9.dat";
...
//		Zunscale+=Wnunscale;
	...
	long double G = -kb*Temp*( log(Zest) + Sl+Sh);
	long double mu = G/N;
...
//	cout<<"obs1 "<<Obs1<<" obs3 "<<Obs3<<" obs4 "<<Obs4<<endl;
	outfile<<std::scientific << setiosflags(ios::fixed)<< setprecision(15)<<Temp<<" "<<Zest<<" "<<H<<" "<<C<<" "<<cvn<<" "<<G<<" "<<Obs4<<" "<<Obs1<<" "<<Obs3<<" "<<Obs2<<endl;
}
