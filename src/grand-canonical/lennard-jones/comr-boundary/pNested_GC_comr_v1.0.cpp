...
#include "/net/uu/nm/cm/bxw109120/src/SimulationCpp/class/Config.h"
...
int main(int argc, char *argv[])
{
	...
	const long double Htop = 1000.0;
	const long double Hlow = -10000.0;
	const long double binwidth = 1.0e-2;
	...
	//Translation step 
 	long double stepguess= 0.5*rdist;
    long double step = stepguess; 

	//run descriptor
	string nds = itos(natoms);
	string rundescript = "NS_Ent_n"+nds+"_comr_a0";
...
//------------------------------------------------------------
	...
	logfile<<"Constant Chemical Potential Nested Sampling Simulation of LJ particles with a hard spherical boundary centered at the configuration COM."<<endl;
