...
//	boxz/=(sca*sca);
	...
	string rundescript = "NS_D_n"+nds+"_binaryLJSE_kappa1_rep14";
...
logfile << " " << endl;
    ...
    Histogram Ehistcurr;
    Histogram Ehistprev;
    Ehistcurr.Initialize(Binwidth, Elow, Etop);
    Ehistprev.Initialize(Binwidth, Elow, Etop);
	RunningStats Estat;
...
//			Tlocala.WrapCoordinates();
			...
			//	cout<<"Eljcrossloc: "<<Eljcrossloc<<endl;
				...
				dE+=dEpljc;
                //add the smoothing bias
                long double bia=0.0;
                if (ii > 0)
                {
                    biascurr = 0.0;
                    biasprev= 0.0;
                    dE+=(biascurr-biasprev);
                }
				//Thermal criterion
