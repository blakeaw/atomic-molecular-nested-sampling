...
int main(int argc, char *argv[])
{
	...
	const unsigned int Nsamples = 200000;
	...
	long double NSfrac = 0.95;
	//Box sizes
	long double boxx = 10.77;//*1.1;
	long double boxy = 10.77;//*1.1;
	long double boxz = 10.77;///(1.1*1.1);
...
//	boxz/=(sca*sca);
	...
	string rundescript = "NS_n"+nds+"_T2.0_rho0.1_rep17";
