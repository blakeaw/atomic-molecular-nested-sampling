...
///
//Input File Name
string filename = "Epoints_NS_CT_n100_c0.dat";
string filename2 = "zObservables_NS_CT_n100_c0.dat";
//Output File Name
string outfilename = "zNestOut_CS_CT_n100_c0.dat";
// Define the the value of K used in simulation
//int Ksample = 700;
long double Temp = 1.4;
// Define the number of atoms in simulation
long double N = 100.0;
long double radius = 2.0;
long double A = 4.0*3.14*radius*radius;
...
//	Obs6 = Obs6/Zest;
	...
	long double F = -kb*Temp*( log(Zest) + S );
...
//	gamma/=dA;
//	gamma/=2.0;
	long double gamma = F/A;
	cout<<"Temp: "<<Temp<<" gamma: "<<gamma<<endl;
	//Output to file
//	cout<<"obs1 "<<Obs1<<" obs3 "<<Obs3<<" obs4 "<<Obs4<<endl;
	outfile<<std::scientific << setiosflags(ios::fixed)<< setprecision(15)<<Temp<<" "<<Zest<<" "<<H<<" "<<C<<" "<<cvn<<" "<<F<<" "<<mu<<" "<<Obs1<<" "<<Obs2<<" "<<endl;
//}
