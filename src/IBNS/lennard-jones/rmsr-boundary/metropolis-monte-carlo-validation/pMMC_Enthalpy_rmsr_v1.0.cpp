...
int main(int argc, char *argv[])
{
	...
	const unsigned Tloop = 10;
	//Temp Range
	const long double Tstart = 1.0;
	const long double Tend = 0.1;
 ...
 //	long double Vexc = 0.5*(4.0/3.0)*pi*(long double)(natoms);
	...
	ofstream obsoutfile("zObservables_MC_Ent_rmsr_a0.dat");
	string coutfilename = "Coord_MC_Ent_rmsr_a0.xyz";
...
cout<<" Average Entalpy is "<<Havg<<" and Average Volume is: "<<Vavg<<" and Average Energy: "<<Eavg<<endl;
long double Tprev = Tcurr-dT;
obsoutfile<<Tprev<<" "<<Havg<<" "<<Eavg<<" "<<Vavg<<" "<<Rgavg<<endl;
