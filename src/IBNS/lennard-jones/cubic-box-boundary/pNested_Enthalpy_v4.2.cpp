...
int main(int argc, char *argv[])
{
	...
	const unsigned int MCit = 80000000;
	...
	const unsigned Cit = 1000;
	//Step Interval to perform volume deformation
	const short Vint = 100;
...
//	long double dconstraint = 6.60;
	...
	long double vstepguess = 0.10;
	long double vstep = vstepguess;	
	//Boltzmann constant
	const long double kb = 1.0;
	const long double pi = 3.14159265359;
	//Pressure
	const long double Press = 0.1;
	const long double bmax = 15.0;
	const long double Vmax = pow(bmax, 3);
 ...
 //	long double Vexc = 0.5*(4.0/3.0)*pi*(long double)(natoms);
	...
	string rundescript = "NS_Ent_n"+nds+"_a0";
	...
	logfile<<"bmax: "<<bmax<<" Htop: "<<Htop<<" Hlow: "<<Hlow<<" Vmax: "<<Vmax<< " Vexc: "<<Vexc<<endl;	
